...
import webservice.hszg.daniel.demo.repository.UserRepository;
import webservice.hszg.daniel.demo.image.ImageRepository;
...
//        this.vehicles.findAll().forEach(v -> log.debug(" Vehicle :" + v.toString()));
        ...
        this.users.save(User.builder()
                .username("postgres")
                .password(this.passwordEncoder.encode("Gideonfell92!"))
